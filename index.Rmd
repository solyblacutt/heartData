...
As said in a study led by [*Department of Anesthesiology, Perioperative and Pain Medicine, Brigham and Women's Hospital and Harvard Medical School*](https://onlinelibrary.wiley.com/doi/abs/10.1111/jocs.12506), female patients undergoing cardiac surgery experience more adverse outcomes.
```{r gender, echo=FALSE}
...
It is seen in this graphic that women temp to go through surgery rather than angioplasty compared with male.
...
AdmissionReasons <- c("Obeses", "Diabetic", "Pulmonary Hypertension")
Angioplasty <- c(numangioplastiaObesos,numangioplastiaDiabetes,numangioplastiaHipertension)
Surgery <- c(numcirujiaObesos,numcirujiaDiabetes,numscirujiaHipertension)
data <- data.frame(AdmissionReasons, Angioplasty, Surgery)
...
Variables election was made taking into account the information previously analyzed. However, not all variables were selected in order to generate the predictor. Pulmonary hypertension, obesity or chronic obstructive pulmonary disease are some examples. This variables do not contain enough information  to make an accurate prediction.

Ages were separated into intervals of young adultos (), adults () and elderly (). It was considered that adultos/elderly population [decir algo mas]
...
It was kept into account that the admissions’ reasons with more prevalence were coronary programations, valv. (valvulopatias?) programations and non-SST ACS (acute coronary syndrome). Predictions were made with these three admissions’ reasons. 
...
```{r e, echo=FALSE, out.width="80%", fig.cap="[*Carlos A Solis-Olivares and Juan M Solis-Soto*](http://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S0188-21982012000200004)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture10.jpg")
```

```{r a, echo=FALSE, out.width="80%", fig.cap="[*Carlos A Solis-Olivares and Juan M Solis-Soto*](http://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S0188-21982012000200004)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture14.jpg")
```

```{r b, echo=FALSE, out.width="80%", fig.cap="[*Carlos A Solis-Olivares and Juan M Solis-Soto*](http://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S0188-21982012000200004)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture15.jpg")
```

```{r c, echo=FALSE, out.width="80%", fig.cap="[*Carlos A Solis-Olivares and Juan M Solis-Soto*](http://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S0188-21982012000200004)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture16.jpg")
```
