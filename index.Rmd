...
The AUROC curve represent the ratios between false positives and false negatives.

```{r auroc, echo=FALSE, out.width="100%", fig.align='center'}
...
```{r e, echo=FALSE, out.width="80%", fig.cap="[*Agustina Verschoor*](mailto: agustina.verschoor@ing.austral.edu.ar)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture9.jpg")
```

```{r a, echo=FALSE, out.width="80%", fig.cap="[*Sofia Tartara Moroni*](mailto: sofia.tartara@ing.austral.edu.ar)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture12.jpg")
```

```{r b, echo=FALSE, out.width="80%", fig.cap="[*Justina Galarce*](mailto: justina.galarce@ing.austral.edu.ar)"}
knitr::include_graphics("C:/Users/solyb/Subjects/R/Algoritmos/heartData/pictures/Picture10.jpg")
```

```{r c, echo=FALSE, out.width="80%", fig.cap="[*Solange Blacutt*](mailto: solange.blacutt@ing.austral.edu.ar)"}
